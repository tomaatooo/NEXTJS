...
const Services = () => {
  return (
    ...
    <ServiceCard img={'/docreader.jpg'} title={'Docreader'} desc={'demo'} link={'/services/docreader'}/>
    <ServiceCard img={'/preader.jpg'} title={'PresReader'} desc={'demo'} link={'/services/presreader'}/>
